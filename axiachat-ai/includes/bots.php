...
function aichat_bots_settings_page() {
    ...
    // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, PluginCheck.Security.DirectDB.UnescapedDBParameter -- Admin-only read of internal table.
    ...
    if ( function_exists( 'aichat_log_debug' ) ) {
        aichat_log_debug( 'Bots page render templates', [
  ...
  <div class="wrap">
  <h1><?php 
    esc_html_e( 'Chatbots', 'axiachat-ai' );
    ?></h1>
    ...
    <div class="aichat-layout">
      <div class="aichat-bot-wrapper">
        <div class="aichat-tabs">
          <button type="button" id="aichat-tabs-prev" class="aichat-sbtn" aria-label="<?php 
    esc_attr_e( 'Scroll left', 'axiachat-ai' );
    ?>" style="display:none">
            <i class="bi bi-chevron-left"></i>
          </button>

          <div id="aichat-tab-strip" class="aichat-tab-strip" role="tablist" aria-label="<?php 
    esc_attr_e( 'Chatbot tabs', 'axiachat-ai' );
    ?>"></div>

          <button type="button" id="aichat-tabs-next" class="aichat-sbtn" aria-label="<?php 
    esc_attr_e( 'Scroll right', 'axiachat-ai' );
    ?>" style="display:none">
