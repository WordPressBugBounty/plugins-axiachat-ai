...
function aichat_easycfg_get_providers() {
    $providers = [
        'gemini' => [
            ...
            'description' => __( 'Gemini 3.1 Flash-Lite (default fast/cheap), 3.5 Flash, 3.1 Pro and 3 Flash. Google\'s latest AI technology.', 'axiachat-ai' ),
        ...
        'openai' => [
            ...
            'description' => __( 'GPT-5.4 Mini (default fast/cheap), GPT-5.4, GPT-5.5. Best for general purpose chat.', 'axiachat-ai' ),
        ...
        'claude' => [
            ...
            'description' => __( 'Claude Sonnet 4.6 (recommended), Haiku 4.5 (fast), Opus 4.8 (premium). Great for nuanced conversations.', 'axiachat-ai' ),
