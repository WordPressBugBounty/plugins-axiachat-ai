...
function aichat_easycfg_get_providers() {
    $providers = [
        'gemini' => [
            ...
            'description' => __( 'Gemini 3.5 Flash (default fast chat), 3.1 Flash-Lite (lowest cost) and 3.1 Pro. 2.5/2.0 models are legacy.', 'axiachat-ai' ),
        ...
        'openai' => [
            ...
            'description' => __( 'GPT-5.6 Luna (default efficient chat), Terra, Sol, plus GPT-5.5/5.4 legacy options. Best for general purpose chat.', 'axiachat-ai' ),
        ...
        'claude' => [
            ...
            'description' => __( 'Claude Haiku 4.5 (default fast/cheap), Sonnet 5 (balanced), Opus 4.8 and Fable 5 (premium). Great for nuanced conversations.', 'axiachat-ai' ),
